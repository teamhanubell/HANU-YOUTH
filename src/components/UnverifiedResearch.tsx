...
const MOCK_RESEARCH: Research[] = [
  ...
  },
  {
    ...
    description: 'A comprehensive study on the ethical implications of artificial intelligence in educational settings. This research explores bias detection, privacy concerns, and responsible AI implementation in learning management systems.',
    category: 'Technology',
    points: 150,
    status: 'in_review',
    ...
    tags: ['AI ethics', 'education technology', 'privacy', 'bias detection']
  },
  {
    id: 2,
    title: 'Climate Change Education for Youth',
    description: 'Research on effective methodologies for teaching climate science to young learners. Includes case studies from 15 countries and innovative approaches to environmental education.',
    category: 'Environment',
    points: 180,
    status: 'pending',
    submittedBy: 'Green Education Initiative',
    ...
    tags: ['climate change', 'environmental education', 'youth engagement']
  },
  {
    id: 3,
    title: 'Digital Divide and Remote Learning',
    description: 'Analysis of the digital divide impact on remote learning during global disruptions. Examines accessibility challenges and proposes solutions for inclusive digital education.',
    category: 'Technology',
    points: 120,
    status: 'rejected',
    submittedBy: 'Digital Equity Research Group',
    ...
    tags: ['digital divide', 'remote learning', 'accessibility', 'equity']
  },
  {
    id: 4,
    title: 'Gamification in Language Learning',
    description: 'Study on the effectiveness of gamification techniques in second language acquisition. Includes experimental data from 500+ participants across multiple language pairs.',
    category: 'Education',
    points: 160,
    status: 'published',
    submittedBy: 'Language Learning Lab',
    ...
    tags: ['gamification', 'language learning', 'second language acquisition']
  },
  {
    id: 5,
    title: 'Sustainable Development Goals in Higher Education',
    description: 'Comprehensive review of how universities worldwide are integrating UN Sustainable Development Goals into their curricula and research programs.',
    category: 'Policy',
    points: 220,
    status: 'in_review',
    submittedBy: 'Global University Network',
    ...
    tags: ['SDGs', 'higher education', 'sustainability', 'curriculum integration']
  }
];
